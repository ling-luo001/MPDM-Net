...
def main():
    ...
    parser.add_argument('--exp_name', default='Mamba_emb_basis_16_2_dual_tower_interaction')
    ...
    with torch.no_grad():
        ...
        dummy_input3 = torch.rand(1, 256, 256).to(device)
        flops, params = profile(model, inputs=(dummy_input1, dummy_input2, dummy_input3))
...
# FLOPs = 9.763913728G
# Params = 0.550712M
# Generator Parameters : 985208
# 16：13 -16：15 - 16：26 1000steps    s/b = 0.67
